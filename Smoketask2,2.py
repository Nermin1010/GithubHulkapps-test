#To check whether the button BUY IT NOW work properly
...
driver.find_element(By. CSS_SELECTOR, "#product-form-template--14211560177749__main > div.product-form__buttons > div > div > div > div > button.shopify-payment-button__button.shopify-payment-button__button--unbranded.BUz42FHpSPncCPJ4Pr_f.jjzYeefyWpPZLH9pIgyw.RWJ0IfBjxIhflh4AIrUw").click()
time.sleep(5)