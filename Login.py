...
driver.get("https://qa-practical-test.myshopify.com/account/login")
driver.find_element(By. ID, "CustomerEmail").send_keys("nerminjusic018@gmail.com")
driver.find_element(By. ID, "CustomerPassword").send_keys("nermin")
